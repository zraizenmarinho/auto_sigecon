...
funcoes_matriculas = {
    ...
    'qualificacao_iti_presencial': obter_matriculas_qualificacao_itine_presencial_tag,
    'aprendizagem_tec_presencial': obter_matriculas_aprendizagem_tecnica_presencial_tag,
    'tecnico_presencial': obter_matriculas_tecnico_presencial_tag,
    'tecnico_distancia': obter_matriculas_tecnico_distancia_tag,
    'tecnico_iti_presencial': obter_matriculas_tecnico_iti_presencial_tag
}
