...
tag_iniciacao_presencial = obter_matriculas_por_tipo_jan(url, key, '1117376 SENAI Taguatinga', '5 Iniciação Profissional', '1 Presencial')
tag_iniciacao_distancia = obter_matriculas_por_tipo_jan(url, key, '1117376 SENAI Taguatinga', '5 Iniciação Profissional', '2 A distância')
tag_aprendizagem_presencial = obter_matriculas_por_tipo_jan(url, key, '1117376 SENAI Taguatinga', '11 Aprendizagem Industrial básica', '1 Presencial')
tag_qualificacao_presencial = obter_matriculas_por_tipo_jan(url, key, '1117376 SENAI Taguatinga', '21 Qualificação Profissional', '1 Presencial')
tag_aprendizagem_distancia = obter_matriculas_por_tipo_jan(url, key, '1117376 SENAI Taguatinga', '11 Aprendizagem Industrial básica', '2 A distância')
tag_qualificacao_distancia = obter_matriculas_por_tipo_jan(url, key, '1117376 SENAI Taguatinga', '21 Qualificação Profissional', '2 A distância')
tag_aperfeicoamento_presencial = obter_matriculas_por_tipo_jan(url, key, '1117376 SENAI Taguatinga', '58 Aperfeiçoamento/Especialização Profissional', '1 Presencial')
tag_aperfeicoamento_distancia = obter_matriculas_por_tipo_jan(url, key, '1117376 SENAI Taguatinga', '58 Aperfeiçoamento/Especialização Profissional', '2 A distância')
tag_qualificacao_iti_presencial = obter_matriculas_por_tipo_jan(url, key, '1117376 SENAI Taguatinga', '22 Qualificação Profissional - Itinerário V Ensino Médio', '1 Presencial')
tag_aprendizagem_tec = obter_matriculas_por_tipo_jan(url, key, '1117376 SENAI Taguatinga', '15 Aprendizagem Industrial Técnica de Nível Médio', '1 Presencial')
tag_tecnico_presencial = obter_matriculas_por_tipo_jan(url, key, '1117376 SENAI Taguatinga', '31 Técnico de Nível Médio', '1 Presencial')
tag_tecnico_distancia = obter_matriculas_por_tipo_jan(url, key, '1117376 SENAI Taguatinga', '31 Técnico de Nível Médio', '2 A distância')
tag_tecnico_iti_presencial = obter_matriculas_por_tipo_jan(url, key, '1117376 SENAI Taguatinga', '32 Técnico de Nível Médio - Itinerário V Ensino Médio', '1 Presencial')
