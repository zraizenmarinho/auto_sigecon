    ...
    for mes_atual, mes_referencia in meses.items():
        for tipo_financiamento in ['1 Gratuidade Regimental', '2 Gratuidade Não Regimental', '3 Convênio', '9 Pago por Pessoa Fisica ou Empresa']:
            ...
            resultados_mat[chave_resultado] = matriculas_por_tipo.contar_matriculas(
                unidade, modalidade, tipo_acao, '92024', mes_referencia, '2024', tipo_financiamento
            )
...
def obter_matriculas_iniciacao_presencial_gam():
    return obter_matriculas('5171003 SENAI Sobradinho', '5 Iniciação Profissional', '1 Presencial', 'inicia_presen_mat')

def obter_matriculas_iniciacao_distancia_gam():
    return obter_matriculas('5171003 SENAI Sobradinho', '5 Iniciação Profissional', '2 A distância', 'inicia_distan_mat')

def obter_matriculas_aprendizagem_presencial_gam():
    return obter_matriculas('5171003 SENAI Sobradinho', '11 Aprendizagem Industrial básica', '1 Presencial', 'aprendi_presen_mat')

def obter_matriculas_qualificacao_presencial_gam():
    return obter_matriculas('5171003 SENAI Sobradinho', '21 Qualificação Profissional', '1 Presencial', 'qualifi_presen_mat')

def obter_matriculas_aprendizagem_distancia_gam():
    return obter_matriculas('5171003 SENAI Sobradinho', '11 Aprendizagem Industrial básica', '2 A distância', 'aprendi_distan_mat')

def obter_matriculas_qualificacao_distancia_gam():
    return obter_matriculas('5171003 SENAI Sobradinho', '21 Qualificação Profissional', '2 A distância', 'qualifi_distan_mat')

def obter_matriculas_aperfeicoamento_presencial_gam():
    return obter_matriculas('5171003 SENAI Sobradinho', '58 Aperfeiçoamento/Especialização Profissional', '1 Presencial', 'aperfei_presen_mat')

def obter_matriculas_aperfeicoamento_distancia_gam():
    return obter_matriculas('5171003 SENAI Sobradinho', '58 Aperfeiçoamento/Especialização Profissional', '2 A distância', 'aperfei_distan_mat')

def obter_matriculas_qualificacao_itine_presencial_gam():
    return obter_matriculas('5171003 SENAI Sobradinho', '22 Qualificação Profissional - Itinerário V Ensino Médio', '1 Presencial', 'qualifi_iti_presen_mat')

def obter_matriculas_aprendizagem_tecnica_presencial_gam():
    return obter_matriculas('5171003 SENAI Sobradinho', '15 Aprendizagem Industrial Técnica de Nível Médio', '1 Presencial', 'aprendi_tec_presen_mat')

def obter_matriculas_tecnico_presencial_gam():
    return obter_matriculas('5171003 SENAI Sobradinho', '31 Técnico de Nível Médio', '1 Presencial', 'tecni_presen_mat')

def obter_matriculas_tecnico_distancia_gam():
    return obter_matriculas('5171003 SENAI Sobradinho', '31 Técnico de Nível Médio', '2 A distância', 'tecni_distan_mat')

def obter_matriculas_tecnico_iti_presencial_gam():
    return obter_matriculas('5171003 SENAI Sobradinho', '32 Técnico de Nível Médio - Itinerário V Ensino Médio', '1 Presencial', 'tecni_iti_presen_mat')
