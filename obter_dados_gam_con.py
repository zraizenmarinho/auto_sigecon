    ...
    class ConcluintesPorTipoFinanciamento:
        ...
        def contar_concluintes(self, unidade, modalidade, tipo_acao, mes_rela, mes_referencia, anos_referencia, tipo_financiamento,tipo_situacao):
            response = self.supabase.table("si_ep").select("*") \
                ...
                .eq("SITUACAO_conRICULA", tipo_situacao) \
                .execute()
            data = response.data
            return len(data)
...
def obter_concluintes_iniciacao_presencial_gam():
    return obter_concluintes('1117374 SENAI Gama', '5 Iniciação Profissional', '1 Presencial', 'inicia_presen_con')

def obter_concluintes_iniciacao_distancia_gam():
    return obter_concluintes('1117374 SENAI Gama', '5 Iniciação Profissional', '2 A distância', 'inicia_distan_con')

def obter_concluintes_aprendizagem_presencial_gam():
    return obter_concluintes('1117374 SENAI Gama', '11 Aprendizagem Industrial básica', '1 Presencial', 'aprendi_presen_con')

def obter_concluintes_qualificacao_presencial_gam():
    return obter_concluintes('1117374 SENAI Gama', '21 Qualificação Profissional', '1 Presencial', 'qualifi_presen_con')

def obter_concluintes_aprendizagem_distancia_gam():
    return obter_concluintes('1117374 SENAI Gama', '11 Aprendizagem Industrial básica', '2 A distância', 'aprendi_distan_con')

def obter_concluintes_qualificacao_distancia_gam():
    return obter_concluintes('1117374 SENAI Gama', '21 Qualificação Profissional', '2 A distância', 'qualifi_distan_con')

def obter_concluintes_aperfeicoamento_presencial_gam():
    return obter_concluintes('1117374 SENAI Gama', '58 Aperfeiçoamento/Especialização Profissional', '1 Presencial', 'aperfei_presen_con')

def obter_concluintes_aperfeicoamento_distancia_gam():
    return obter_concluintes('1117374 SENAI Gama', '58 Aperfeiçoamento/Especialização Profissional', '2 A distância', 'aperfei_distan_con')

def obter_concluintes_qualificacao_itine_presencial_gam():
    return obter_concluintes('1117374 SENAI Gama', '22 Qualificação Profissional - Itinerário V Ensino Médio', '1 Presencial', 'qualifi_iti_presen_con')

def obter_concluintes_aprendizagem_tecnica_presencial_gam():
    return obter_concluintes('1117374 SENAI Gama', '15 Aprendizagem Industrial Técnica de Nível Médio', '1 Presencial', 'aprendi_tec_presen_con')

def obter_concluintes_tecnico_presencial_gam():
    return obter_concluintes('1117374 SENAI Gama', '31 Técnico de Nível Médio', '1 Presencial', 'tecni_presen_con')

def obter_concluintes_tecnico_distancia_gam():
    return obter_concluintes('1117374 SENAI Gama', '31 Técnico de Nível Médio', '2 A distância', 'tecni_distan_con')

def obter_concluintes_tecnico_iti_presencial_gam():
    return obter_concluintes('1117374 SENAI Gama', '32 Técnico de Nível Médio - Itinerário V Ensino Médio', '1 Presencial', 'tecni_iti_presen_con')
