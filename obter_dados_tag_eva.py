    ...
    for mes_atual, mes_referencia in meses.items():
        for tipo_financiamento in ['1 Gratuidade Regimental', '2 Gratuidade Não Regimental', '3 Convênio', '9 Pago por Pessoa Fisica ou Empresa']:
            ...
            resultados_eva[chave_resultado] = evadidos_por_tipo.contar_evadidos(
                unidade, modalidade, tipo_acao, '72024', mes_referencia, '2024', tipo_financiamento,'4 Evadidos'
            )
...
def obter_evadidos_qualificacao_itine_presencial_tag(file_path):
    return obter_evadidos(file_path, '1117376 SENAI Taguatinga', '22 Qualificação Profissional - Itinerário V Ensino Médio', '1 Presencial', 'qualifi_iti_presen_con')
...
def obter_evadidos_tecnico_iti_presencial_tag(file_path):
    return obter_evadidos(file_path, '1117376 SENAI Taguatinga', '32 Técnico de Nível Médio - Itinerário V Ensino Médio', '1 Presencial', 'tecni_iti_presen_eva')
