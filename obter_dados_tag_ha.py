...
def obter_hora_iniciacao_presencial_tag(file_path):
    return obter_horas(file_path, '1117376 SENAI Taguatinga', '5 Iniciação Profissional', '1 Presencial', 'inicia_presen')

def obter_hora_iniciacao_distancia_tag(file_path):
    return obter_horas(file_path, '1117376 SENAI Taguatinga', '5 Iniciação Profissional', '2 A distância', 'inicia_distan')

def obter_hora_aprendizagem_presencial_tag(file_path):
    return obter_horas(file_path, '1117376 SENAI Taguatinga', '11 Aprendizagem Industrial básica', '1 Presencial', 'aprendi_presen')

def obter_hora_qualificacao_presencial_tag(file_path):
    return obter_horas(file_path, '1117376 SENAI Taguatinga', '21 Qualificação Profissional', '1 Presencial', 'qualifi_presen')

def obter_hora_aprendizagem_distancia_tag(file_path):
    return obter_horas(file_path, '1117376 SENAI Taguatinga', '11 Aprendizagem Industrial básica', '2 A distância', 'aprendi_distan')

def obter_hora_qualificacao_distancia_tag(file_path):
    return obter_horas(file_path, '1117376 SENAI Taguatinga', '21 Qualificação Profissional', '2 A distância', 'qualifi_distan')

def obter_hora_aperfeicoamento_presencial_tag(file_path):
    return obter_horas(file_path, '1117376 SENAI Taguatinga', '58 Aperfeiçoamento/Especialização Profissional', '1 Presencial', 'aperfei_presen')

def obter_hora_aperfeicoamento_distancia_tag(file_path):
    return obter_horas(file_path, '1117376 SENAI Taguatinga', '58 Aperfeiçoamento/Especialização Profissional', '2 A distância', 'aperfei_distan')

def obter_hora_qualificacao_iti_presencial_tag(file_path):
    return obter_horas(file_path, '1117376 SENAI Taguatinga', '22 Qualificação Profissional - Itinerário V Ensino Médio', '1 Presencial', 'qualifi_iti_presen')

def obter_hora_aprendizagem_tec_presencial_tag(file_path):
    return obter_horas(file_path, '1117376 SENAI Taguatinga', '15 Aprendizagem Industrial Técnica de Nível Médio', '1 Presencial', 'aprendi_tec_presen')

def obter_hora_tecnico_presencial_tag(file_path):
    return obter_horas(file_path, '1117376 SENAI Taguatinga', '31 Técnico de Nível Médio', '1 Presencial', 'tecni_presen')

def obter_hora_tecnico_distancia_tag(file_path):
    return obter_horas(file_path, '1117376 SENAI Taguatinga', '31 Técnico de Nível Médio', '2 A distância', 'tecni_distan')

def obter_hora_tecnico_iti_presencial_tag(file_path):
    return obter_horas(file_path, '1117376 SENAI Taguatinga', '32 Técnico de Nível Médio - Itinerário V Ensino Médio', '1 Presencial', 'tecni_iti_presen')
